...
LOG_FILENAME = "15_complex_emotion.log"
CHECKPOINT_PREFIX = "15_complex_emotion"
...
def write_run_manifest(repo_rows, summary_rows, config):
    manifest_path = Path(config.logging.extraction_log_dir) / "15_complex_emotion_manifest.json"
    manifest_path.parent.mkdir(parents=True, exist_ok=True)
    payload = {
        "script": "15_complex_emotion.py",
...
def main():
    ...
    summary_path = Path(config.logging.extraction_log_dir) / "15_complex_emotion_summary.csv"
